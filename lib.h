...
enum Tokens{NUMERO=1, IDENTIFICADOR, MAIS, MAIOR, MENOS, ATRIBUICAO, DIVISAO, MULTIPLICACAO, L_PAR, R_PAR, L_CHAVES, R_CHAVES, L_BRAC, R_BRAC, VIRGULA, COMMA, MENOR, MAIOR_IGUAL, DIFERENTE};
